...
<a
	...
	target="_blank"
	rel="noreferrer"
	class="fixed right-5 bottom-5 z-50 flex size-14 items-center justify-center rounded-full bg-(--color-secondary) text-white shadow-[0_16px_35px_rgba(76,175,80,0.35)]"
