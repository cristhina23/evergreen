...
<section class="py-8">
	<Container>
		<div
			class="grid overflow-hidden rounded-3xl bg-gradient-to-br from-[var(--color-secondary)] via-[#07917b] to-[var(--color-primary)] text-white shadow-[0_24px_70px_rgba(15,39,68,0.16)] lg:grid-cols-[1fr_1.15fr_1.05fr]"
		>
			<div class="p-6 sm:p-8">
				...
				<Button label={franchiseInfo.cta} variant="soft" class="mt-5" />
			</div>
			...
			<div class="relative min-h-64">
				...
				<div class="absolute inset-0 flex items-center justify-center">
					<button
						class="flex size-16 items-center justify-center rounded-full bg-white text-[var(--color-primary)] shadow-xl"
						aria-label={franchiseInfo.videoLabel}
					>
