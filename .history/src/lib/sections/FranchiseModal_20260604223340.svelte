			...
			>
				...
				<div>
					...
					<input
						...
						required
						autocomplete="name"
						class="w-full rounded-2xl border border-[var(--color-border)] px-4 py-3 outline-none transition focus:border-[var(--color-secondary)] focus:ring-2 focus:ring-[var(--color-secondary)]/20"
					/>
				</div>
				...
				<div>
					...
					<input
						...
						class="w-full rounded-2xl border border-(--color-border) px-4 py-3 outline-none transition focus:border-[var(--color-secondary)] focus:ring-2 focus:ring-[var(--color-secondary)]/20"
					/>
				</div>
