	...
	<div class="fixed inset-0 z-[999] flex items-center justify-center p-4">
		...
		>
			<button
				...
				class="absolute top-5 right-5 flex size-10 items-center justify-center rounded-full bg-[var(--color-surface)] text-(--color-text-secondary) transition hover:bg-(--color-border)"
			>
				<X size={20} />
			</button>
