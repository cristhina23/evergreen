...
<section class="py-8">
	<Container>
		<div
			class="grid overflow-hidden rounded-3xl bg-linear-to-br from-[var(--color-secondary)] via-[#07917b] to-(--color-primary) text-white shadow-[0_24px_70px_rgba(15,39,68,0.16)] lg:grid-cols-[1fr_1.15fr_1.05fr]"
		>
