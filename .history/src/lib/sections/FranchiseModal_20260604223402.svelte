			...
			>
				...
				<div>
					...
					<input
						...
						required
						autocomplete="tel"
						class="w-full rounded-2xl border border-(--color-border) px-4 py-3 outline-none transition focus:border-(--color-secondary) focus:ring-2 focus:ring-[var(--color-secondary)]/20"
					/>
				</div>
